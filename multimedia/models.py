...
class Cartegories(models.Model):
    ...
    cart_image = ResizedImageField(size=[760, 420], upload_to="cartegories/", default="https://images.unsplash.com/photo-1579713899713-bcd3efe713aa?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
    def __str__(self):
